...
test -f ~/Pictures/pics.zip || wget -q -O ~/Pictures/pics.zip http://zonzorp.net/pics.tgz
...
test -f ~/Pictures/pics.tgz || tar -xzvf pics.tgz -C ~/Pictures && rm ~/Pictures/pics.tgz
